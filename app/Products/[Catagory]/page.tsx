...
export default function CategoryPage() {
  ...
  const slug = typeof params?.Catagory === "string"
    ? decodeURIComponent(params.Catagory).toLowerCase()
    : "";
    ...
    <div className="min-h-screen bg-[#f8f9fa] pt-24 pb-12">
      <div className="max-w-7xl mx-auto px-8 mb-10 text-center">
        ...
        <h1 className="text-5xl font-black text-gray-900">
          <span className="text-emerald-800">{displayName}</span>
        </h1>
      </div>
        ...
        {!loading && !error && products.length === 0 && (
          <div className="text-center py-20">
            ...
            <p className="text-gray-500">
              We don&apos;t have any {displayName} products yet.
            </p>
          </div>
        )}
      </div>
